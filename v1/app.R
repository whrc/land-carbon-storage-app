...
gm.key <- ifelse(dev, Sys.getenv('GOOGLE_MAPS_API_KEY_UNRESTRICTED'), Sys.getenv('GOOGLE_MAPS_API_KEY'))
...
adm.polys <- read_sf('shp/ne_10m_admin_0_countries_WGS84_small.shp')
eco.polys <- read_sf('shp/Ecoregions2017_WGS84_smaller.shp')
...
ui <- bootstrapPage(
	...
	tags$head(
		...
		tags$style(
			...
			#optionsPanel {
				width: 260px;
				height: 100%;
				box-shadow: 6px 0px 5px -5px rgba(0, 0, 0, 0.2);
			}
		...
		# Esri Leaflet Geocoder, see https://github.com/Esri/esri-leaflet-geocoder
		tags$script(src = 'https://unpkg.com/esri-leaflet'),
		tags$link(rel = 'stylesheet', href = 'https://unpkg.com/esri-leaflet-geocoder/dist/esri-leaflet-geocoder.css'),
		tags$script(src = 'https://unpkg.com/esri-leaflet-geocoder'),
	...
	absolutePanel(
		...
		# div(class = 'appLogoText', 'LAND', 'CARBON', 'STORAGE'),
			...
			absolutePanel(
				...
				div(id = 'optionsPanel', class = 'panelBody', style = 'text-align: justify;',
					...
					HTML("
						...
						<p>
							The Land Carbon Storage Platform is a data sharing, visualization, and analysis application built by:
						</p>
